...
/**
 * The FileField model module.
 * @module model/FileField
 * @version 3
 */
class FileField {
    /**
     * Constructs a new <code>FileField</code>.
     * @alias module:model/FileField
    ...
    constructor(clazz) { 
        ...
        FileField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>FileField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileField} obj Optional instance to populate.
     * @return {module:model/FileField} The populated <code>FileField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileField();
    ...
    /**
     * Validates the JSON data with respect to <code>FileField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FileField.RequiredProperties) {
            if (!data[property]) {
...
FileField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
FileField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
FileField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
FileField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
FileField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
FileField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
FileField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
FileField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
FileField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
FileField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
FileField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
FileField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
FileField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
FileField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
FileField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
FileField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
FileField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
FileField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
FileField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
FileField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
FileField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
FileField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
FileField.prototype['iDate'] = undefined;

/**
 * @member {module:model/FileField.DataTypeEnum} dataType
 */
FileField.prototype['dataType'] = undefined;
