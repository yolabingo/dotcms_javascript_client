...
/**
 * The StoryBlockField model module.
 * @module model/StoryBlockField
 * @version 3
 */
class StoryBlockField {
    /**
     * Constructs a new <code>StoryBlockField</code>.
     * @alias module:model/StoryBlockField
    ...
    constructor(clazz) { 
        ...
        StoryBlockField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>StoryBlockField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoryBlockField} obj Optional instance to populate.
     * @return {module:model/StoryBlockField} The populated <code>StoryBlockField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoryBlockField();
    ...
    /**
     * Validates the JSON data with respect to <code>StoryBlockField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoryBlockField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of StoryBlockField.RequiredProperties) {
            if (!data[property]) {
...
StoryBlockField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
StoryBlockField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
StoryBlockField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
StoryBlockField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
StoryBlockField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
StoryBlockField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
StoryBlockField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
StoryBlockField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
StoryBlockField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
StoryBlockField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
StoryBlockField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
StoryBlockField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
StoryBlockField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
StoryBlockField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
StoryBlockField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
StoryBlockField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
StoryBlockField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
StoryBlockField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
StoryBlockField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
StoryBlockField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
StoryBlockField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
StoryBlockField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
StoryBlockField.prototype['iDate'] = undefined;

/**
 * @member {module:model/StoryBlockField.DataTypeEnum} dataType
 */
StoryBlockField.prototype['dataType'] = undefined;
...
export default StoryBlockField;
