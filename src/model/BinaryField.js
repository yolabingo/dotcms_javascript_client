...
/**
 * The BinaryField model module.
 * @module model/BinaryField
 * @version 3
 */
class BinaryField {
    /**
     * Constructs a new <code>BinaryField</code>.
     * @alias module:model/BinaryField
    ...
    constructor(clazz) { 
        ...
        BinaryField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>BinaryField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BinaryField} obj Optional instance to populate.
     * @return {module:model/BinaryField} The populated <code>BinaryField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BinaryField();
    ...
    /**
     * Validates the JSON data with respect to <code>BinaryField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BinaryField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BinaryField.RequiredProperties) {
            if (!data[property]) {
...
BinaryField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
BinaryField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
BinaryField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
BinaryField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
BinaryField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
BinaryField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
BinaryField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
BinaryField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
BinaryField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
BinaryField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
BinaryField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
BinaryField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
BinaryField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
BinaryField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
BinaryField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
BinaryField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
BinaryField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
BinaryField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
BinaryField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
BinaryField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
BinaryField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
BinaryField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
BinaryField.prototype['iDate'] = undefined;

/**
 * @member {module:model/BinaryField.DataTypeEnum} dataType
 */
BinaryField.prototype['dataType'] = undefined;
