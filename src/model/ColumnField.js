...
/**
 * The ColumnField model module.
 * @module model/ColumnField
 * @version 3
 */
class ColumnField {
    /**
     * Constructs a new <code>ColumnField</code>.
     * @alias module:model/ColumnField
    ...
    constructor(clazz) { 
        ...
        ColumnField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>ColumnField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ColumnField} obj Optional instance to populate.
     * @return {module:model/ColumnField} The populated <code>ColumnField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ColumnField();
    ...
    /**
     * Validates the JSON data with respect to <code>ColumnField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ColumnField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ColumnField.RequiredProperties) {
            if (!data[property]) {
...
ColumnField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
ColumnField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
ColumnField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
ColumnField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
ColumnField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
ColumnField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
ColumnField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
ColumnField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
ColumnField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
ColumnField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
ColumnField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
ColumnField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
ColumnField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
ColumnField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
ColumnField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
ColumnField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
ColumnField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
ColumnField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
ColumnField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
ColumnField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
ColumnField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
ColumnField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
ColumnField.prototype['iDate'] = undefined;

/**
 * @member {module:model/ColumnField.DataTypeEnum} dataType
 */
ColumnField.prototype['dataType'] = undefined;
