...
/**
 * The HostFolderField model module.
 * @module model/HostFolderField
 * @version 3
 */
class HostFolderField {
    /**
     * Constructs a new <code>HostFolderField</code>.
     * @alias module:model/HostFolderField
    ...
    constructor(clazz) { 
        ...
        HostFolderField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>HostFolderField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HostFolderField} obj Optional instance to populate.
     * @return {module:model/HostFolderField} The populated <code>HostFolderField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HostFolderField();
    ...
    /**
     * Validates the JSON data with respect to <code>HostFolderField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HostFolderField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HostFolderField.RequiredProperties) {
            if (!data[property]) {
...
HostFolderField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
HostFolderField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
HostFolderField.prototype['unique'] = undefined;

/**
 * @member {Boolean} listed
 */
HostFolderField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
HostFolderField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
HostFolderField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
HostFolderField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
HostFolderField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
HostFolderField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
HostFolderField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
HostFolderField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
HostFolderField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
HostFolderField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
HostFolderField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
HostFolderField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
HostFolderField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
HostFolderField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
HostFolderField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
HostFolderField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
HostFolderField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
HostFolderField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
HostFolderField.prototype['iDate'] = undefined;

/**
 * @member {Boolean} indexed
 */
HostFolderField.prototype['indexed'] = undefined;

/**
 * @member {module:model/HostFolderField.DataTypeEnum} dataType
 */
HostFolderField.prototype['dataType'] = undefined;
...
export default HostFolderField;
