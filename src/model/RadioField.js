...
/**
 * The RadioField model module.
 * @module model/RadioField
 * @version 3
 */
class RadioField {
    /**
     * Constructs a new <code>RadioField</code>.
     * @alias module:model/RadioField
    ...
    constructor(clazz) { 
        ...
        RadioField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>RadioField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RadioField} obj Optional instance to populate.
     * @return {module:model/RadioField} The populated <code>RadioField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RadioField();
    ...
    /**
     * Validates the JSON data with respect to <code>RadioField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RadioField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RadioField.RequiredProperties) {
            if (!data[property]) {
...
RadioField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
RadioField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
RadioField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
RadioField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
RadioField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
RadioField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
RadioField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
RadioField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
RadioField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
RadioField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
RadioField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
RadioField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
RadioField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
RadioField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
RadioField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
RadioField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
RadioField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
RadioField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
RadioField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
RadioField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
RadioField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
RadioField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
RadioField.prototype['iDate'] = undefined;

/**
 * @member {module:model/RadioField.DataTypeEnum} dataType
 */
RadioField.prototype['dataType'] = undefined;
