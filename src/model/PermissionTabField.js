...
/**
 * The PermissionTabField model module.
 * @module model/PermissionTabField
 * @version 3
 */
class PermissionTabField {
    /**
     * Constructs a new <code>PermissionTabField</code>.
     * @alias module:model/PermissionTabField
    ...
    constructor(clazz) { 
        ...
        PermissionTabField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>PermissionTabField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PermissionTabField} obj Optional instance to populate.
     * @return {module:model/PermissionTabField} The populated <code>PermissionTabField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PermissionTabField();
    ...
    /**
     * Validates the JSON data with respect to <code>PermissionTabField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PermissionTabField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PermissionTabField.RequiredProperties) {
            if (!data[property]) {
...
PermissionTabField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
PermissionTabField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
PermissionTabField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
PermissionTabField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
PermissionTabField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
PermissionTabField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
PermissionTabField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
PermissionTabField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
PermissionTabField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
PermissionTabField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
PermissionTabField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
PermissionTabField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
PermissionTabField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
PermissionTabField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
PermissionTabField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
PermissionTabField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
PermissionTabField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
PermissionTabField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
PermissionTabField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
PermissionTabField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
PermissionTabField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
PermissionTabField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
PermissionTabField.prototype['iDate'] = undefined;

/**
 * @member {module:model/PermissionTabField.DataTypeEnum} dataType
 */
PermissionTabField.prototype['dataType'] = undefined;
 ...
 * @readonly
 */
PermissionTabField['DataTypeEnum'] = {
...
export default PermissionTabField;
