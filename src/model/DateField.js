...
/**
 * The DateField model module.
 * @module model/DateField
 * @version 3
 */
class DateField {
    /**
     * Constructs a new <code>DateField</code>.
     * @alias module:model/DateField
    ...
    constructor(clazz) { 
        ...
        DateField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>DateField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateField} obj Optional instance to populate.
     * @return {module:model/DateField} The populated <code>DateField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DateField();
    ...
    /**
     * Validates the JSON data with respect to <code>DateField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DateField.RequiredProperties) {
            if (!data[property]) {
...
DateField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
DateField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
DateField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
DateField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
DateField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
DateField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
DateField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
DateField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
DateField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
DateField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
DateField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
DateField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
DateField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
DateField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
DateField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
DateField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
DateField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
DateField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
DateField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
DateField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
DateField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
DateField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
DateField.prototype['iDate'] = undefined;

/**
 * @member {module:model/DateField.DataTypeEnum} dataType
 */
DateField.prototype['dataType'] = undefined;
