...
/**
 * The RelationshipsTabField model module.
 * @module model/RelationshipsTabField
 * @version 3
 */
class RelationshipsTabField {
    /**
     * Constructs a new <code>RelationshipsTabField</code>.
     * @alias module:model/RelationshipsTabField
    ...
    constructor(clazz) { 
        ...
        RelationshipsTabField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>RelationshipsTabField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RelationshipsTabField} obj Optional instance to populate.
     * @return {module:model/RelationshipsTabField} The populated <code>RelationshipsTabField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RelationshipsTabField();
    ...
    /**
     * Validates the JSON data with respect to <code>RelationshipsTabField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RelationshipsTabField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RelationshipsTabField.RequiredProperties) {
            if (!data[property]) {
...
RelationshipsTabField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
RelationshipsTabField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
RelationshipsTabField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
RelationshipsTabField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
RelationshipsTabField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
RelationshipsTabField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
RelationshipsTabField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
RelationshipsTabField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
RelationshipsTabField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
RelationshipsTabField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
RelationshipsTabField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
RelationshipsTabField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
RelationshipsTabField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
RelationshipsTabField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
RelationshipsTabField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
RelationshipsTabField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
RelationshipsTabField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
RelationshipsTabField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
RelationshipsTabField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
RelationshipsTabField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
RelationshipsTabField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
RelationshipsTabField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
RelationshipsTabField.prototype['iDate'] = undefined;

/**
 * @member {module:model/RelationshipsTabField.DataTypeEnum} dataType
 */
RelationshipsTabField.prototype['dataType'] = undefined;
 ...
 * @readonly
 */
RelationshipsTabField['DataTypeEnum'] = {
...
export default RelationshipsTabField;
