...
/**
 * The HiddenField model module.
 * @module model/HiddenField
 * @version 3
 */
class HiddenField {
    /**
     * Constructs a new <code>HiddenField</code>.
     * @alias module:model/HiddenField
    ...
    constructor(clazz) { 
        ...
        HiddenField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>HiddenField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HiddenField} obj Optional instance to populate.
     * @return {module:model/HiddenField} The populated <code>HiddenField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HiddenField();
    ...
    /**
     * Validates the JSON data with respect to <code>HiddenField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>HiddenField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of HiddenField.RequiredProperties) {
            if (!data[property]) {
...
HiddenField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
HiddenField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
HiddenField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
HiddenField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
HiddenField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
HiddenField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
HiddenField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
HiddenField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
HiddenField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
HiddenField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
HiddenField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
HiddenField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
HiddenField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
HiddenField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
HiddenField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
HiddenField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
HiddenField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
HiddenField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
HiddenField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
HiddenField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
HiddenField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
HiddenField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
HiddenField.prototype['iDate'] = undefined;

/**
 * @member {module:model/HiddenField.DataTypeEnum} dataType
 */
HiddenField.prototype['dataType'] = undefined;
