...
/**
 * The LineDividerField model module.
 * @module model/LineDividerField
 * @version 3
 */
class LineDividerField {
    /**
     * Constructs a new <code>LineDividerField</code>.
     * @alias module:model/LineDividerField
    ...
    constructor(clazz) { 
        ...
        LineDividerField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>LineDividerField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineDividerField} obj Optional instance to populate.
     * @return {module:model/LineDividerField} The populated <code>LineDividerField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineDividerField();
    ...
    /**
     * Validates the JSON data with respect to <code>LineDividerField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LineDividerField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LineDividerField.RequiredProperties) {
            if (!data[property]) {
...
LineDividerField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
LineDividerField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
LineDividerField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
LineDividerField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
LineDividerField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
LineDividerField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
LineDividerField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
LineDividerField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
LineDividerField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
LineDividerField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
LineDividerField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
LineDividerField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
LineDividerField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
LineDividerField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
LineDividerField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
LineDividerField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
LineDividerField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
LineDividerField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
LineDividerField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
LineDividerField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
LineDividerField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
LineDividerField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
LineDividerField.prototype['iDate'] = undefined;

/**
 * @member {module:model/LineDividerField.DataTypeEnum} dataType
 */
LineDividerField.prototype['dataType'] = undefined;
...
export default LineDividerField;
