...
/**
 * The FileAssetContentType model module.
 * @module model/FileAssetContentType
 * @version 3
 */
class FileAssetContentType {
    /**
     * Constructs a new <code>FileAssetContentType</code>.
     * @alias module:model/FileAssetContentType
    ...
    constructor(clazz) { 
        ...
        FileAssetContentType.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>FileAssetContentType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FileAssetContentType} obj Optional instance to populate.
     * @return {module:model/FileAssetContentType} The populated <code>FileAssetContentType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FileAssetContentType();
    ...
    /**
     * Validates the JSON data with respect to <code>FileAssetContentType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FileAssetContentType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FileAssetContentType.RequiredProperties) {
            if (!data[property]) {
...
FileAssetContentType.RequiredProperties = ["clazz"];

/**
 * @member {String} name
 */
FileAssetContentType.prototype['name'] = undefined;

/**
 * @member {String} id
 */
FileAssetContentType.prototype['id'] = undefined;

/**
 * @member {String} description
 */
FileAssetContentType.prototype['description'] = undefined;

/**
 * @member {Boolean} defaultType
 */
FileAssetContentType.prototype['defaultType'] = undefined;

/**
 * @member {String} detailPage
 */
FileAssetContentType.prototype['detailPage'] = undefined;

/**
 * @member {Boolean} fixed
 */
FileAssetContentType.prototype['fixed'] = undefined;

/**
 * @member {Date} iDate
 */
FileAssetContentType.prototype['iDate'] = undefined;

/**
 * @member {Boolean} system
 */
FileAssetContentType.prototype['system'] = undefined;

/**
 * @member {Boolean} versionable
 */
FileAssetContentType.prototype['versionable'] = undefined;

/**
 * @member {Boolean} multilingualable
 */
FileAssetContentType.prototype['multilingualable'] = undefined;

/**
 * @member {String} variable
 */
FileAssetContentType.prototype['variable'] = undefined;

/**
 * @member {String} urlMapPattern
 */
FileAssetContentType.prototype['urlMapPattern'] = undefined;

/**
 * @member {String} publishDateVar
 */
FileAssetContentType.prototype['publishDateVar'] = undefined;

/**
 * @member {String} expireDateVar
 */
FileAssetContentType.prototype['expireDateVar'] = undefined;

/**
 * @member {Date} modDate
 */
FileAssetContentType.prototype['modDate'] = undefined;

/**
 * @member {String} host
 */
FileAssetContentType.prototype['host'] = undefined;

/**
 * @member {String} siteName
 */
FileAssetContentType.prototype['siteName'] = undefined;

/**
 * @member {String} icon
 */
FileAssetContentType.prototype['icon'] = undefined;

/**
 * @member {Number} sortOrder
 */
FileAssetContentType.prototype['sortOrder'] = undefined;

/**
 * @member {String} folder
 */
FileAssetContentType.prototype['folder'] = undefined;

/**
 * @member {String} folderPath
 */
FileAssetContentType.prototype['folderPath'] = undefined;
...
export default FileAssetContentType;
