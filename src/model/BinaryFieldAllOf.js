...
/**
 * The BinaryFieldAllOf model module.
 * @module model/BinaryFieldAllOf
 * @version 3
 */
class BinaryFieldAllOf {
    /**
     * Constructs a new <code>BinaryFieldAllOf</code>.
     * @alias module:model/BinaryFieldAllOf
     */
    constructor() { 
        
        BinaryFieldAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BinaryFieldAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BinaryFieldAllOf} obj Optional instance to populate.
     * @return {module:model/BinaryFieldAllOf} The populated <code>BinaryFieldAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BinaryFieldAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>BinaryFieldAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BinaryFieldAllOf</code>.
     */
...
export default BinaryFieldAllOf;
