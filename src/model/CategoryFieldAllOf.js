...
/**
 * The CategoryFieldAllOf model module.
 * @module model/CategoryFieldAllOf
 * @version 3
 */
class CategoryFieldAllOf {
    /**
     * Constructs a new <code>CategoryFieldAllOf</code>.
     * @alias module:model/CategoryFieldAllOf
     */
    constructor() { 
        
        CategoryFieldAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CategoryFieldAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CategoryFieldAllOf} obj Optional instance to populate.
     * @return {module:model/CategoryFieldAllOf} The populated <code>CategoryFieldAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CategoryFieldAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>CategoryFieldAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoryFieldAllOf</code>.
     */
 ...
 * @readonly
 */
CategoryFieldAllOf['DataTypeEnum'] = {
...
export default CategoryFieldAllOf;
