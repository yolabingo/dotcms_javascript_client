...
/**
 * The PersonaContentType model module.
 * @module model/PersonaContentType
 * @version 3
 */
class PersonaContentType {
    /**
     * Constructs a new <code>PersonaContentType</code>.
     * @alias module:model/PersonaContentType
    ...
    constructor(clazz) { 
        ...
        PersonaContentType.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>PersonaContentType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PersonaContentType} obj Optional instance to populate.
     * @return {module:model/PersonaContentType} The populated <code>PersonaContentType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PersonaContentType();
    ...
    /**
     * Validates the JSON data with respect to <code>PersonaContentType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PersonaContentType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PersonaContentType.RequiredProperties) {
            if (!data[property]) {
...
PersonaContentType.RequiredProperties = ["clazz"];

/**
 * @member {String} name
 */
PersonaContentType.prototype['name'] = undefined;

/**
 * @member {String} id
 */
PersonaContentType.prototype['id'] = undefined;

/**
 * @member {String} description
 */
PersonaContentType.prototype['description'] = undefined;

/**
 * @member {Boolean} defaultType
 */
PersonaContentType.prototype['defaultType'] = undefined;

/**
 * @member {String} detailPage
 */
PersonaContentType.prototype['detailPage'] = undefined;

/**
 * @member {Boolean} fixed
 */
PersonaContentType.prototype['fixed'] = undefined;

/**
 * @member {Date} iDate
 */
PersonaContentType.prototype['iDate'] = undefined;

/**
 * @member {Boolean} system
 */
PersonaContentType.prototype['system'] = undefined;

/**
 * @member {Boolean} versionable
 */
PersonaContentType.prototype['versionable'] = undefined;

/**
 * @member {Boolean} multilingualable
 */
PersonaContentType.prototype['multilingualable'] = undefined;

/**
 * @member {String} variable
 */
PersonaContentType.prototype['variable'] = undefined;

/**
 * @member {String} urlMapPattern
 */
PersonaContentType.prototype['urlMapPattern'] = undefined;

/**
 * @member {String} publishDateVar
 */
PersonaContentType.prototype['publishDateVar'] = undefined;

/**
 * @member {String} expireDateVar
 */
PersonaContentType.prototype['expireDateVar'] = undefined;

/**
 * @member {Date} modDate
 */
PersonaContentType.prototype['modDate'] = undefined;

/**
 * @member {String} host
 */
PersonaContentType.prototype['host'] = undefined;

/**
 * @member {String} siteName
 */
PersonaContentType.prototype['siteName'] = undefined;

/**
 * @member {String} icon
 */
PersonaContentType.prototype['icon'] = undefined;

/**
 * @member {Number} sortOrder
 */
PersonaContentType.prototype['sortOrder'] = undefined;

/**
 * @member {String} folder
 */
PersonaContentType.prototype['folder'] = undefined;

/**
 * @member {String} folderPath
 */
PersonaContentType.prototype['folderPath'] = undefined;
...
export default PersonaContentType;
