...
/**
 * The TabDividerField model module.
 * @module model/TabDividerField
 * @version 3
 */
class TabDividerField {
    /**
     * Constructs a new <code>TabDividerField</code>.
     * @alias module:model/TabDividerField
    ...
    constructor(clazz) { 
        ...
        TabDividerField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>TabDividerField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TabDividerField} obj Optional instance to populate.
     * @return {module:model/TabDividerField} The populated <code>TabDividerField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TabDividerField();
    ...
    /**
     * Validates the JSON data with respect to <code>TabDividerField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TabDividerField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TabDividerField.RequiredProperties) {
            if (!data[property]) {
...
TabDividerField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
TabDividerField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
TabDividerField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
TabDividerField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
TabDividerField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
TabDividerField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
TabDividerField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
TabDividerField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
TabDividerField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
TabDividerField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
TabDividerField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
TabDividerField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
TabDividerField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
TabDividerField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
TabDividerField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
TabDividerField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
TabDividerField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
TabDividerField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
TabDividerField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
TabDividerField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
TabDividerField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
TabDividerField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
TabDividerField.prototype['iDate'] = undefined;

/**
 * @member {module:model/TabDividerField.DataTypeEnum} dataType
 */
TabDividerField.prototype['dataType'] = undefined;
...
export default TabDividerField;
