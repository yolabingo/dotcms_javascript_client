...
/**
 * The ConstantField model module.
 * @module model/ConstantField
 * @version 3
 */
class ConstantField {
    /**
     * Constructs a new <code>ConstantField</code>.
     * @alias module:model/ConstantField
    ...
    constructor(clazz) { 
        ...
        ConstantField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>ConstantField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ConstantField} obj Optional instance to populate.
     * @return {module:model/ConstantField} The populated <code>ConstantField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConstantField();
    ...
    /**
     * Validates the JSON data with respect to <code>ConstantField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConstantField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConstantField.RequiredProperties) {
            if (!data[property]) {
...
ConstantField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
ConstantField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
ConstantField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
ConstantField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
ConstantField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
ConstantField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
ConstantField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
ConstantField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
ConstantField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
ConstantField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
ConstantField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
ConstantField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
ConstantField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
ConstantField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
ConstantField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
ConstantField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
ConstantField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
ConstantField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
ConstantField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
ConstantField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
ConstantField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
ConstantField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
ConstantField.prototype['iDate'] = undefined;

/**
 * @member {module:model/ConstantField.DataTypeEnum} dataType
 */
ConstantField.prototype['dataType'] = undefined;
