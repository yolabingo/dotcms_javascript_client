...
/**
 * The WysiwygField model module.
 * @module model/WysiwygField
 * @version 3
 */
class WysiwygField {
    /**
     * Constructs a new <code>WysiwygField</code>.
     * @alias module:model/WysiwygField
    ...
    constructor(clazz) { 
        ...
        WysiwygField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>WysiwygField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WysiwygField} obj Optional instance to populate.
     * @return {module:model/WysiwygField} The populated <code>WysiwygField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WysiwygField();
    ...
    /**
     * Validates the JSON data with respect to <code>WysiwygField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WysiwygField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WysiwygField.RequiredProperties) {
            if (!data[property]) {
...
WysiwygField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
WysiwygField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
WysiwygField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
WysiwygField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
WysiwygField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
WysiwygField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
WysiwygField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
WysiwygField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
WysiwygField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
WysiwygField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
WysiwygField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
WysiwygField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
WysiwygField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
WysiwygField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
WysiwygField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
WysiwygField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
WysiwygField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
WysiwygField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
WysiwygField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
WysiwygField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
WysiwygField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
WysiwygField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
WysiwygField.prototype['iDate'] = undefined;

/**
 * @member {module:model/WysiwygField.DataTypeEnum} dataType
 */
WysiwygField.prototype['dataType'] = undefined;
