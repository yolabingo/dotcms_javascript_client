...
/**
 * The RowField model module.
 * @module model/RowField
 * @version 3
 */
class RowField {
    /**
     * Constructs a new <code>RowField</code>.
     * @alias module:model/RowField
    ...
    constructor(clazz) { 
        ...
        RowField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>RowField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RowField} obj Optional instance to populate.
     * @return {module:model/RowField} The populated <code>RowField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RowField();
    ...
    /**
     * Validates the JSON data with respect to <code>RowField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RowField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RowField.RequiredProperties) {
            if (!data[property]) {
...
RowField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
RowField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
RowField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
RowField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
RowField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
RowField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
RowField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
RowField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
RowField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
RowField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
RowField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
RowField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
RowField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
RowField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
RowField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
RowField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
RowField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
RowField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
RowField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
RowField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
RowField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
RowField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
RowField.prototype['iDate'] = undefined;

/**
 * @member {module:model/RowField.DataTypeEnum} dataType
 */
RowField.prototype['dataType'] = undefined;
