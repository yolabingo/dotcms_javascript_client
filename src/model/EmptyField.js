...
/**
 * The EmptyField model module.
 * @module model/EmptyField
 * @version 3
 */
class EmptyField {
    /**
     * Constructs a new <code>EmptyField</code>.
     * @alias module:model/EmptyField
    ...
    constructor(clazz) { 
        ...
        EmptyField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>EmptyField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EmptyField} obj Optional instance to populate.
     * @return {module:model/EmptyField} The populated <code>EmptyField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EmptyField();
    ...
    /**
     * Validates the JSON data with respect to <code>EmptyField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EmptyField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EmptyField.RequiredProperties) {
            if (!data[property]) {
...
EmptyField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
EmptyField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
EmptyField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
EmptyField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
EmptyField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
EmptyField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
EmptyField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
EmptyField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
EmptyField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
EmptyField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
EmptyField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
EmptyField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
EmptyField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
EmptyField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
EmptyField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
EmptyField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
EmptyField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
EmptyField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
EmptyField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
EmptyField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
EmptyField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
EmptyField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
EmptyField.prototype['iDate'] = undefined;

/**
 * @member {module:model/EmptyField.DataTypeEnum} dataType
 */
EmptyField.prototype['dataType'] = undefined;
