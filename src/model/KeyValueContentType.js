...
/**
 * The KeyValueContentType model module.
 * @module model/KeyValueContentType
 * @version 3
 */
class KeyValueContentType {
    /**
     * Constructs a new <code>KeyValueContentType</code>.
     * @alias module:model/KeyValueContentType
    ...
    constructor(clazz) { 
        ...
        KeyValueContentType.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>KeyValueContentType</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyValueContentType} obj Optional instance to populate.
     * @return {module:model/KeyValueContentType} The populated <code>KeyValueContentType</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyValueContentType();
    ...
    /**
     * Validates the JSON data with respect to <code>KeyValueContentType</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyValueContentType</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KeyValueContentType.RequiredProperties) {
            if (!data[property]) {
...
KeyValueContentType.RequiredProperties = ["clazz"];

/**
 * @member {String} name
 */
KeyValueContentType.prototype['name'] = undefined;

/**
 * @member {String} id
 */
KeyValueContentType.prototype['id'] = undefined;

/**
 * @member {String} description
 */
KeyValueContentType.prototype['description'] = undefined;

/**
 * @member {Boolean} defaultType
 */
KeyValueContentType.prototype['defaultType'] = undefined;

/**
 * @member {String} detailPage
 */
KeyValueContentType.prototype['detailPage'] = undefined;

/**
 * @member {Boolean} fixed
 */
KeyValueContentType.prototype['fixed'] = undefined;

/**
 * @member {Date} iDate
 */
KeyValueContentType.prototype['iDate'] = undefined;

/**
 * @member {Boolean} system
 */
KeyValueContentType.prototype['system'] = undefined;

/**
 * @member {Boolean} versionable
 */
KeyValueContentType.prototype['versionable'] = undefined;

/**
 * @member {String} variable
 */
KeyValueContentType.prototype['variable'] = undefined;

/**
 * @member {String} urlMapPattern
 */
KeyValueContentType.prototype['urlMapPattern'] = undefined;

/**
 * @member {String} publishDateVar
 */
KeyValueContentType.prototype['publishDateVar'] = undefined;

/**
 * @member {String} expireDateVar
 */
KeyValueContentType.prototype['expireDateVar'] = undefined;

/**
 * @member {Date} modDate
 */
KeyValueContentType.prototype['modDate'] = undefined;

/**
 * @member {String} host
 */
KeyValueContentType.prototype['host'] = undefined;

/**
 * @member {String} siteName
 */
KeyValueContentType.prototype['siteName'] = undefined;

/**
 * @member {String} icon
 */
KeyValueContentType.prototype['icon'] = undefined;

/**
 * @member {Number} sortOrder
 */
KeyValueContentType.prototype['sortOrder'] = undefined;

/**
 * @member {String} folder
 */
KeyValueContentType.prototype['folder'] = undefined;

/**
 * @member {String} folderPath
 */
KeyValueContentType.prototype['folderPath'] = undefined;

/**
 * @member {Boolean} multilingualable
 */
KeyValueContentType.prototype['multilingualable'] = undefined;
...
export default KeyValueContentType;
