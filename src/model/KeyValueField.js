...
/**
 * The KeyValueField model module.
 * @module model/KeyValueField
 * @version 3
 */
class KeyValueField {
    /**
     * Constructs a new <code>KeyValueField</code>.
     * @alias module:model/KeyValueField
    ...
    constructor(clazz) { 
        ...
        KeyValueField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>KeyValueField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/KeyValueField} obj Optional instance to populate.
     * @return {module:model/KeyValueField} The populated <code>KeyValueField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new KeyValueField();
    ...
    /**
     * Validates the JSON data with respect to <code>KeyValueField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>KeyValueField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of KeyValueField.RequiredProperties) {
            if (!data[property]) {
...
KeyValueField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
KeyValueField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
KeyValueField.prototype['unique'] = undefined;

/**
 * @member {Boolean} listed
 */
KeyValueField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
KeyValueField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
KeyValueField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
KeyValueField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
KeyValueField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
KeyValueField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
KeyValueField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
KeyValueField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
KeyValueField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
KeyValueField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
KeyValueField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
KeyValueField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
KeyValueField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
KeyValueField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
KeyValueField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
KeyValueField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
KeyValueField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
KeyValueField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
KeyValueField.prototype['iDate'] = undefined;

/**
 * @member {Boolean} indexed
 */
KeyValueField.prototype['indexed'] = undefined;

/**
 * @member {module:model/KeyValueField.DataTypeEnum} dataType
 */
KeyValueField.prototype['dataType'] = undefined;
