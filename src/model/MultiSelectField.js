...
/**
 * The MultiSelectField model module.
 * @module model/MultiSelectField
 * @version 3
 */
class MultiSelectField {
    /**
     * Constructs a new <code>MultiSelectField</code>.
     * @alias module:model/MultiSelectField
    ...
    constructor(clazz) { 
        ...
        MultiSelectField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>MultiSelectField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MultiSelectField} obj Optional instance to populate.
     * @return {module:model/MultiSelectField} The populated <code>MultiSelectField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MultiSelectField();
    ...
    /**
     * Validates the JSON data with respect to <code>MultiSelectField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MultiSelectField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MultiSelectField.RequiredProperties) {
            if (!data[property]) {
...
MultiSelectField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
MultiSelectField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
MultiSelectField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
MultiSelectField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
MultiSelectField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
MultiSelectField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
MultiSelectField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
MultiSelectField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
MultiSelectField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
MultiSelectField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
MultiSelectField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
MultiSelectField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
MultiSelectField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
MultiSelectField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
MultiSelectField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
MultiSelectField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
MultiSelectField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
MultiSelectField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
MultiSelectField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
MultiSelectField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
MultiSelectField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
MultiSelectField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
MultiSelectField.prototype['iDate'] = undefined;

/**
 * @member {module:model/MultiSelectField.DataTypeEnum} dataType
 */
MultiSelectField.prototype['dataType'] = undefined;
