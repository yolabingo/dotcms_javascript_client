...
/**
 * The TimeField model module.
 * @module model/TimeField
 * @version 3
 */
class TimeField {
    /**
     * Constructs a new <code>TimeField</code>.
     * @alias module:model/TimeField
    ...
    constructor(clazz) { 
        ...
        TimeField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>TimeField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeField} obj Optional instance to populate.
     * @return {module:model/TimeField} The populated <code>TimeField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeField();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TimeField.RequiredProperties) {
            if (!data[property]) {
...
TimeField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
TimeField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
TimeField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
TimeField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
TimeField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
TimeField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
TimeField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
TimeField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
TimeField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
TimeField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
TimeField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
TimeField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
TimeField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
TimeField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
TimeField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
TimeField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
TimeField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
TimeField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
TimeField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
TimeField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
TimeField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
TimeField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
TimeField.prototype['iDate'] = undefined;

/**
 * @member {module:model/TimeField.DataTypeEnum} dataType
 */
TimeField.prototype['dataType'] = undefined;
