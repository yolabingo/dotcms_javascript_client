...
/**
 * The TextAreaField model module.
 * @module model/TextAreaField
 * @version 3
 */
class TextAreaField {
    /**
     * Constructs a new <code>TextAreaField</code>.
     * @alias module:model/TextAreaField
    ...
    constructor(clazz) { 
        ...
        TextAreaField.initialize(this, clazz);
    }
    ...
    /**
     * Constructs a <code>TextAreaField</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TextAreaField} obj Optional instance to populate.
     * @return {module:model/TextAreaField} The populated <code>TextAreaField</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TextAreaField();
    ...
    /**
     * Validates the JSON data with respect to <code>TextAreaField</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TextAreaField</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TextAreaField.RequiredProperties) {
            if (!data[property]) {
...
TextAreaField.RequiredProperties = ["clazz"];

/**
 * @member {Boolean} searchable
 */
TextAreaField.prototype['searchable'] = undefined;

/**
 * @member {Boolean} unique
 */
TextAreaField.prototype['unique'] = undefined;

/**
 * @member {Boolean} indexed
 */
TextAreaField.prototype['indexed'] = undefined;

/**
 * @member {Boolean} listed
 */
TextAreaField.prototype['listed'] = undefined;

/**
 * @member {Boolean} readOnly
 */
TextAreaField.prototype['readOnly'] = undefined;

/**
 * @member {Boolean} forceIncludeInApi
 */
TextAreaField.prototype['forceIncludeInApi'] = undefined;

/**
 * @member {String} owner
 */
TextAreaField.prototype['owner'] = undefined;

/**
 * @member {String} id
 */
TextAreaField.prototype['id'] = undefined;

/**
 * @member {Date} modDate
 */
TextAreaField.prototype['modDate'] = undefined;

/**
 * @member {String} name
 */
TextAreaField.prototype['name'] = undefined;

/**
 * @member {String} relationType
 */
TextAreaField.prototype['relationType'] = undefined;

/**
 * @member {Boolean} required
 */
TextAreaField.prototype['required'] = undefined;

/**
 * @member {String} variable
 */
TextAreaField.prototype['variable'] = undefined;

/**
 * @member {Number} sortOrder
 */
TextAreaField.prototype['sortOrder'] = undefined;

/**
 * @member {String} values
 */
TextAreaField.prototype['values'] = undefined;

/**
 * @member {String} regexCheck
 */
TextAreaField.prototype['regexCheck'] = undefined;

/**
 * @member {String} hint
 */
TextAreaField.prototype['hint'] = undefined;

/**
 * @member {String} defaultValue
 */
TextAreaField.prototype['defaultValue'] = undefined;

/**
 * @member {Boolean} fixed
 */
TextAreaField.prototype['fixed'] = undefined;

/**
 * @member {String} contentTypeId
 */
TextAreaField.prototype['contentTypeId'] = undefined;

/**
 * @member {String} dbColumn
 */
TextAreaField.prototype['dbColumn'] = undefined;

/**
 * @member {Date} iDate
 */
TextAreaField.prototype['iDate'] = undefined;

/**
 * @member {module:model/TextAreaField.DataTypeEnum} dataType
 */
TextAreaField.prototype['dataType'] = undefined;
