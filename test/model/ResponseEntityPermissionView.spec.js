...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityPermissionView();
  });
  ...
  describe('ResponseEntityPermissionView', function() {
    it('should create an instance of ResponseEntityPermissionView', function() {
      // uncomment below and update the code to test ResponseEntityPermissionView
      //var instance = new DotCmsRestApi.ResponseEntityPermissionView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityPermissionView);
    });
