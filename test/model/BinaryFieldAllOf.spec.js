...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.BinaryFieldAllOf();
  });
  ...
  describe('BinaryFieldAllOf', function() {
    it('should create an instance of BinaryFieldAllOf', function() {
      // uncomment below and update the code to test BinaryFieldAllOf
      //var instance = new DotCmsRestApi.BinaryFieldAllOf();
      //expect(instance).to.be.a(DotCmsRestApi.BinaryFieldAllOf);
    });
