...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityExperimentView();
  });
  ...
  describe('ResponseEntityExperimentView', function() {
    it('should create an instance of ResponseEntityExperimentView', function() {
      // uncomment below and update the code to test ResponseEntityExperimentView
      //var instance = new DotCmsRestApi.ResponseEntityExperimentView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityExperimentView);
    });
