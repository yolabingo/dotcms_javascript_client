...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.GenerateBundleForm();
  });
  ...
  describe('GenerateBundleForm', function() {
    it('should create an instance of GenerateBundleForm', function() {
      // uncomment below and update the code to test GenerateBundleForm
      //var instance = new DotCmsRestApi.GenerateBundleForm();
      //expect(instance).to.be.a(DotCmsRestApi.GenerateBundleForm);
    });
