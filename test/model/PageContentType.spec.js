...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.PageContentType();
  });
  ...
  describe('PageContentType', function() {
    it('should create an instance of PageContentType', function() {
      // uncomment below and update the code to test PageContentType
      //var instance = new DotCmsRestApi.PageContentType();
      //expect(instance).to.be.a(DotCmsRestApi.PageContentType);
    });
