...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FilteredContentTypesForm();
  });
  ...
  describe('FilteredContentTypesForm', function() {
    it('should create an instance of FilteredContentTypesForm', function() {
      // uncomment below and update the code to test FilteredContentTypesForm
      //var instance = new DotCmsRestApi.FilteredContentTypesForm();
      //expect(instance).to.be.a(DotCmsRestApi.FilteredContentTypesForm);
    });
