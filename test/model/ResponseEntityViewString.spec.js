...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityViewString();
  });
  ...
  describe('ResponseEntityViewString', function() {
    it('should create an instance of ResponseEntityViewString', function() {
      // uncomment below and update the code to test ResponseEntityViewString
      //var instance = new DotCmsRestApi.ResponseEntityViewString();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityViewString);
    });
