...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RestConditionGroup();
  });
  ...
  describe('RestConditionGroup', function() {
    it('should create an instance of RestConditionGroup', function() {
      // uncomment below and update the code to test RestConditionGroup
      //var instance = new DotCmsRestApi.RestConditionGroup();
      //expect(instance).to.be.a(DotCmsRestApi.RestConditionGroup);
    });
