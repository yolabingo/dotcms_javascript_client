...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FormContentType();
  });
  ...
  describe('FormContentType', function() {
    it('should create an instance of FormContentType', function() {
      // uncomment below and update the code to test FormContentType
      //var instance = new DotCmsRestApi.FormContentType();
      //expect(instance).to.be.a(DotCmsRestApi.FormContentType);
    });
