...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.EmptyField();
  });
  ...
  describe('EmptyField', function() {
    it('should create an instance of EmptyField', function() {
      // uncomment below and update the code to test EmptyField
      //var instance = new DotCmsRestApi.EmptyField();
      //expect(instance).to.be.a(DotCmsRestApi.EmptyField);
    });
