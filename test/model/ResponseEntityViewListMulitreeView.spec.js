...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityViewListMulitreeView();
  });
  ...
  describe('ResponseEntityViewListMulitreeView', function() {
    it('should create an instance of ResponseEntityViewListMulitreeView', function() {
      // uncomment below and update the code to test ResponseEntityViewListMulitreeView
      //var instance = new DotCmsRestApi.ResponseEntityViewListMulitreeView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityViewListMulitreeView);
    });
