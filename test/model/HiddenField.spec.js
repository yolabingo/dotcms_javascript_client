...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.HiddenField();
  });
  ...
  describe('HiddenField', function() {
    it('should create an instance of HiddenField', function() {
      // uncomment below and update the code to test HiddenField
      //var instance = new DotCmsRestApi.HiddenField();
      //expect(instance).to.be.a(DotCmsRestApi.HiddenField);
    });
