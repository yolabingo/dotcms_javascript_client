...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.CheckboxField();
  });
  ...
  describe('CheckboxField', function() {
    it('should create an instance of CheckboxField', function() {
      // uncomment below and update the code to test CheckboxField
      //var instance = new DotCmsRestApi.CheckboxField();
      //expect(instance).to.be.a(DotCmsRestApi.CheckboxField);
    });
