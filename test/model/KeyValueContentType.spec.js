...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.KeyValueContentType();
  });
  ...
  describe('KeyValueContentType', function() {
    it('should create an instance of KeyValueContentType', function() {
      // uncomment below and update the code to test KeyValueContentType
      //var instance = new DotCmsRestApi.KeyValueContentType();
      //expect(instance).to.be.a(DotCmsRestApi.KeyValueContentType);
    });
