...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FormContentTypeAllOf();
  });
  ...
  describe('FormContentTypeAllOf', function() {
    it('should create an instance of FormContentTypeAllOf', function() {
      // uncomment below and update the code to test FormContentTypeAllOf
      //var instance = new DotCmsRestApi.FormContentTypeAllOf();
      //expect(instance).to.be.a(DotCmsRestApi.FormContentTypeAllOf);
    });
