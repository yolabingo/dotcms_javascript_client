...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.VanityUrlContentType();
  });
  ...
  describe('VanityUrlContentType', function() {
    it('should create an instance of VanityUrlContentType', function() {
      // uncomment below and update the code to test VanityUrlContentType
      //var instance = new DotCmsRestApi.VanityUrlContentType();
      //expect(instance).to.be.a(DotCmsRestApi.VanityUrlContentType);
    });
