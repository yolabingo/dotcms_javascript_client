...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FileField();
  });
  ...
  describe('FileField', function() {
    it('should create an instance of FileField', function() {
      // uncomment below and update the code to test FileField
      //var instance = new DotCmsRestApi.FileField();
      //expect(instance).to.be.a(DotCmsRestApi.FileField);
    });
