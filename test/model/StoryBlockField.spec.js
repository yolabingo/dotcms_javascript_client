...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.StoryBlockField();
  });
  ...
  describe('StoryBlockField', function() {
    it('should create an instance of StoryBlockField', function() {
      // uncomment below and update the code to test StoryBlockField
      //var instance = new DotCmsRestApi.StoryBlockField();
      //expect(instance).to.be.a(DotCmsRestApi.StoryBlockField);
    });
