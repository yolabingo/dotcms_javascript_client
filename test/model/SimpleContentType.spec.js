...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.SimpleContentType();
  });
  ...
  describe('SimpleContentType', function() {
    it('should create an instance of SimpleContentType', function() {
      // uncomment below and update the code to test SimpleContentType
      //var instance = new DotCmsRestApi.SimpleContentType();
      //expect(instance).to.be.a(DotCmsRestApi.SimpleContentType);
    });
