...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseHostVariableEntityView();
  });
  ...
  describe('ResponseHostVariableEntityView', function() {
    it('should create an instance of ResponseHostVariableEntityView', function() {
      // uncomment below and update the code to test ResponseHostVariableEntityView
      //var instance = new DotCmsRestApi.ResponseHostVariableEntityView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseHostVariableEntityView);
    });
