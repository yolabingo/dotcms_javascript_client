...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.HostVariable();
  });
  ...
  describe('HostVariable', function() {
    it('should create an instance of HostVariable', function() {
      // uncomment below and update the code to test HostVariable
      //var instance = new DotCmsRestApi.HostVariable();
      //expect(instance).to.be.a(DotCmsRestApi.HostVariable);
    });
