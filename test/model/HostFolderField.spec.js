...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.HostFolderField();
  });
  ...
  describe('HostFolderField', function() {
    it('should create an instance of HostFolderField', function() {
      // uncomment below and update the code to test HostFolderField
      //var instance = new DotCmsRestApi.HostFolderField();
      //expect(instance).to.be.a(DotCmsRestApi.HostFolderField);
    });
