...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TextAreaField();
  });
  ...
  describe('TextAreaField', function() {
    it('should create an instance of TextAreaField', function() {
      // uncomment below and update the code to test TextAreaField
      //var instance = new DotCmsRestApi.TextAreaField();
      //expect(instance).to.be.a(DotCmsRestApi.TextAreaField);
    });
