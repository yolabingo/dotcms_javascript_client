...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FireActionForm();
  });
  ...
  describe('FireActionForm', function() {
    it('should create an instance of FireActionForm', function() {
      // uncomment below and update the code to test FireActionForm
      //var instance = new DotCmsRestApi.FireActionForm();
      //expect(instance).to.be.a(DotCmsRestApi.FireActionForm);
    });
