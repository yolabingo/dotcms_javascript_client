...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.WysiwygField();
  });
  ...
  describe('WysiwygField', function() {
    it('should create an instance of WysiwygField', function() {
      // uncomment below and update the code to test WysiwygField
      //var instance = new DotCmsRestApi.WysiwygField();
      //expect(instance).to.be.a(DotCmsRestApi.WysiwygField);
    });
