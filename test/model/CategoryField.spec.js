...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.CategoryField();
  });
  ...
  describe('CategoryField', function() {
    it('should create an instance of CategoryField', function() {
      // uncomment below and update the code to test CategoryField
      //var instance = new DotCmsRestApi.CategoryField();
      //expect(instance).to.be.a(DotCmsRestApi.CategoryField);
    });
