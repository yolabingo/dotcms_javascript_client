...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.FireActionByNameForm();
  });
  ...
  describe('FireActionByNameForm', function() {
    it('should create an instance of FireActionByNameForm', function() {
      // uncomment below and update the code to test FireActionByNameForm
      //var instance = new DotCmsRestApi.FireActionByNameForm();
      //expect(instance).to.be.a(DotCmsRestApi.FireActionByNameForm);
    });
    ...
    it('should have the property pathToMove (base name: "pathToMove")', function() {
      // uncomment below and update the code to test the property pathToMove
      //var instance = new DotCmsRestApi.FireActionByNameForm();
      //expect(instance).to.be();
    });
    ...
    it('should have the property individualPermissions (base name: "individualPermissions")', function() {
      // uncomment below and update the code to test the property individualPermissions
      //var instance = new DotCmsRestApi.FireActionByNameForm();
      //expect(instance).to.be();
    });
