...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.Permissionable();
  });
  ...
  describe('Permissionable', function() {
    it('should create an instance of Permissionable', function() {
      // uncomment below and update the code to test Permissionable
      //var instance = new DotCmsRestApi.Permissionable();
      //expect(instance).to.be.a(DotCmsRestApi.Permissionable);
    });
