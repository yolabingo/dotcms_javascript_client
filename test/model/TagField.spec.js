...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TagField();
  });
  ...
  describe('TagField', function() {
    it('should create an instance of TagField', function() {
      // uncomment below and update the code to test TagField
      //var instance = new DotCmsRestApi.TagField();
      //expect(instance).to.be.a(DotCmsRestApi.TagField);
    });
