...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TemplateLayoutRow();
  });
  ...
  describe('TemplateLayoutRow', function() {
    it('should create an instance of TemplateLayoutRow', function() {
      // uncomment below and update the code to test TemplateLayoutRow
      //var instance = new DotCmsRestApi.TemplateLayoutRow();
      //expect(instance).to.be.a(DotCmsRestApi.TemplateLayoutRow);
    });
