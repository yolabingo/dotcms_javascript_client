...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.UpdateUserForm();
  });
  ...
  describe('UpdateUserForm', function() {
    it('should create an instance of UpdateUserForm', function() {
      // uncomment below and update the code to test UpdateUserForm
      //var instance = new DotCmsRestApi.UpdateUserForm();
      //expect(instance).to.be.a(DotCmsRestApi.UpdateUserForm);
    });
