...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.UpdateTagForm();
  });
  ...
  describe('UpdateTagForm', function() {
    it('should create an instance of UpdateTagForm', function() {
      // uncomment below and update the code to test UpdateTagForm
      //var instance = new DotCmsRestApi.UpdateTagForm();
      //expect(instance).to.be.a(DotCmsRestApi.UpdateTagForm);
    });
