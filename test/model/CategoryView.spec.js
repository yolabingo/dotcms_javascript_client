...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.CategoryView();
  });
  ...
  describe('CategoryView', function() {
    it('should create an instance of CategoryView', function() {
      // uncomment below and update the code to test CategoryView
      //var instance = new DotCmsRestApi.CategoryView();
      //expect(instance).to.be.a(DotCmsRestApi.CategoryView);
    });
