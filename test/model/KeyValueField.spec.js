...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.KeyValueField();
  });
  ...
  describe('KeyValueField', function() {
    it('should create an instance of KeyValueField', function() {
      // uncomment below and update the code to test KeyValueField
      //var instance = new DotCmsRestApi.KeyValueField();
      //expect(instance).to.be.a(DotCmsRestApi.KeyValueField);
    });
