...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntitySmallRoleView();
  });
  ...
  describe('ResponseEntitySmallRoleView', function() {
    it('should create an instance of ResponseEntitySmallRoleView', function() {
      // uncomment below and update the code to test ResponseEntitySmallRoleView
      //var instance = new DotCmsRestApi.ResponseEntitySmallRoleView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntitySmallRoleView);
    });
