...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RadioField();
  });
  ...
  describe('RadioField', function() {
    it('should create an instance of RadioField', function() {
      // uncomment below and update the code to test RadioField
      //var instance = new DotCmsRestApi.RadioField();
      //expect(instance).to.be.a(DotCmsRestApi.RadioField);
    });
