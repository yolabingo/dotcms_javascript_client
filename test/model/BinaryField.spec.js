...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.BinaryField();
  });
  ...
  describe('BinaryField', function() {
    it('should create an instance of BinaryField', function() {
      // uncomment below and update the code to test BinaryField
      //var instance = new DotCmsRestApi.BinaryField();
      //expect(instance).to.be.a(DotCmsRestApi.BinaryField);
    });
