...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityView();
  });
  ...
  describe('ResponseEntityView', function() {
    it('should create an instance of ResponseEntityView', function() {
      // uncomment below and update the code to test ResponseEntityView
      //var instance = new DotCmsRestApi.ResponseEntityView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityView);
    });
