...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TabDividerField();
  });
  ...
  describe('TabDividerField', function() {
    it('should create an instance of TabDividerField', function() {
      // uncomment below and update the code to test TabDividerField
      //var instance = new DotCmsRestApi.TabDividerField();
      //expect(instance).to.be.a(DotCmsRestApi.TabDividerField);
    });
