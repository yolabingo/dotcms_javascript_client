...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityViewMapStringObject();
  });
  ...
  describe('ResponseEntityViewMapStringObject', function() {
    it('should create an instance of ResponseEntityViewMapStringObject', function() {
      // uncomment below and update the code to test ResponseEntityViewMapStringObject
      //var instance = new DotCmsRestApi.ResponseEntityViewMapStringObject();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityViewMapStringObject);
    });
