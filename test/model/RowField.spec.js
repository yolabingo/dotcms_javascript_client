...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RowField();
  });
  ...
  describe('RowField', function() {
    it('should create an instance of RowField', function() {
      // uncomment below and update the code to test RowField
      //var instance = new DotCmsRestApi.RowField();
      //expect(instance).to.be.a(DotCmsRestApi.RowField);
    });
