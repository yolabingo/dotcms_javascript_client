...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TemplateLayoutColumnView();
  });
  ...
  describe('TemplateLayoutColumnView', function() {
    it('should create an instance of TemplateLayoutColumnView', function() {
      // uncomment below and update the code to test TemplateLayoutColumnView
      //var instance = new DotCmsRestApi.TemplateLayoutColumnView();
      //expect(instance).to.be.a(DotCmsRestApi.TemplateLayoutColumnView);
    });
