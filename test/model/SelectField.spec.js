...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.SelectField();
  });
  ...
  describe('SelectField', function() {
    it('should create an instance of SelectField', function() {
      // uncomment below and update the code to test SelectField
      //var instance = new DotCmsRestApi.SelectField();
      //expect(instance).to.be.a(DotCmsRestApi.SelectField);
    });
