...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.PermissionTabField();
  });
  ...
  describe('PermissionTabField', function() {
    it('should create an instance of PermissionTabField', function() {
      // uncomment below and update the code to test PermissionTabField
      //var instance = new DotCmsRestApi.PermissionTabField();
      //expect(instance).to.be.a(DotCmsRestApi.PermissionTabField);
    });
