...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseSiteVariablesEntityView();
  });
  ...
  describe('ResponseSiteVariablesEntityView', function() {
    it('should create an instance of ResponseSiteVariablesEntityView', function() {
      // uncomment below and update the code to test ResponseSiteVariablesEntityView
      //var instance = new DotCmsRestApi.ResponseSiteVariablesEntityView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseSiteVariablesEntityView);
    });
