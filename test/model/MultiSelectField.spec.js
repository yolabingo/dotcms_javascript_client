...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.MultiSelectField();
  });
  ...
  describe('MultiSelectField', function() {
    it('should create an instance of MultiSelectField', function() {
      // uncomment below and update the code to test MultiSelectField
      //var instance = new DotCmsRestApi.MultiSelectField();
      //expect(instance).to.be.a(DotCmsRestApi.MultiSelectField);
    });
