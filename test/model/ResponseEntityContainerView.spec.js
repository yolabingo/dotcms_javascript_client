...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ResponseEntityContainerView();
  });
  ...
  describe('ResponseEntityContainerView', function() {
    it('should create an instance of ResponseEntityContainerView', function() {
      // uncomment below and update the code to test ResponseEntityContainerView
      //var instance = new DotCmsRestApi.ResponseEntityContainerView();
      //expect(instance).to.be.a(DotCmsRestApi.ResponseEntityContainerView);
    });
