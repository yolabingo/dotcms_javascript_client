...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.DotAssetContentType();
  });
  ...
  describe('DotAssetContentType', function() {
    it('should create an instance of DotAssetContentType', function() {
      // uncomment below and update the code to test DotAssetContentType
      //var instance = new DotCmsRestApi.DotAssetContentType();
      //expect(instance).to.be.a(DotCmsRestApi.DotAssetContentType);
    });
