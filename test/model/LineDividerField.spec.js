...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.LineDividerField();
  });
  ...
  describe('LineDividerField', function() {
    it('should create an instance of LineDividerField', function() {
      // uncomment below and update the code to test LineDividerField
      //var instance = new DotCmsRestApi.LineDividerField();
      //expect(instance).to.be.a(DotCmsRestApi.LineDividerField);
    });
