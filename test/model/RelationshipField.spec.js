...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RelationshipField();
  });
  ...
  describe('RelationshipField', function() {
    it('should create an instance of RelationshipField', function() {
      // uncomment below and update the code to test RelationshipField
      //var instance = new DotCmsRestApi.RelationshipField();
      //expect(instance).to.be.a(DotCmsRestApi.RelationshipField);
    });
