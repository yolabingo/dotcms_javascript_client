...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RoleLayoutForm();
  });
  ...
  describe('RoleLayoutForm', function() {
    it('should create an instance of RoleLayoutForm', function() {
      // uncomment below and update the code to test RoleLayoutForm
      //var instance = new DotCmsRestApi.RoleLayoutForm();
      //expect(instance).to.be.a(DotCmsRestApi.RoleLayoutForm);
    });
