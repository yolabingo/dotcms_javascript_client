...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.MulitreeView();
  });
  ...
  describe('MulitreeView', function() {
    it('should create an instance of MulitreeView', function() {
      // uncomment below and update the code to test MulitreeView
      //var instance = new DotCmsRestApi.MulitreeView();
      //expect(instance).to.be.a(DotCmsRestApi.MulitreeView);
    });
