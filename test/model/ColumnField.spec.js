...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ColumnField();
  });
  ...
  describe('ColumnField', function() {
    it('should create an instance of ColumnField', function() {
      // uncomment below and update the code to test ColumnField
      //var instance = new DotCmsRestApi.ColumnField();
      //expect(instance).to.be.a(DotCmsRestApi.ColumnField);
    });
