...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.DotAssetContentTypeAllOf();
  });
  ...
  describe('DotAssetContentTypeAllOf', function() {
    it('should create an instance of DotAssetContentTypeAllOf', function() {
      // uncomment below and update the code to test DotAssetContentTypeAllOf
      //var instance = new DotCmsRestApi.DotAssetContentTypeAllOf();
      //expect(instance).to.be.a(DotCmsRestApi.DotAssetContentTypeAllOf);
    });
