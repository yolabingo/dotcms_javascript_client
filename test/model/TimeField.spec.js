...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.TimeField();
  });
  ...
  describe('TimeField', function() {
    it('should create an instance of TimeField', function() {
      // uncomment below and update the code to test TimeField
      //var instance = new DotCmsRestApi.TimeField();
      //expect(instance).to.be.a(DotCmsRestApi.TimeField);
    });
