...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.WidgetContentType();
  });
  ...
  describe('WidgetContentType', function() {
    it('should create an instance of WidgetContentType', function() {
      // uncomment below and update the code to test WidgetContentType
      //var instance = new DotCmsRestApi.WidgetContentType();
      //expect(instance).to.be.a(DotCmsRestApi.WidgetContentType);
    });
