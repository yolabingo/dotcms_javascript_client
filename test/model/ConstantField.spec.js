...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.ConstantField();
  });
  ...
  describe('ConstantField', function() {
    it('should create an instance of ConstantField', function() {
      // uncomment below and update the code to test ConstantField
      //var instance = new DotCmsRestApi.ConstantField();
      //expect(instance).to.be.a(DotCmsRestApi.ConstantField);
    });
