...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.RelationshipsTabField();
  });
  ...
  describe('RelationshipsTabField', function() {
    it('should create an instance of RelationshipsTabField', function() {
      // uncomment below and update the code to test RelationshipsTabField
      //var instance = new DotCmsRestApi.RelationshipsTabField();
      //expect(instance).to.be.a(DotCmsRestApi.RelationshipsTabField);
    });
