...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.PersonaContentType();
  });
  ...
  describe('PersonaContentType', function() {
    it('should create an instance of PersonaContentType', function() {
      // uncomment below and update the code to test PersonaContentType
      //var instance = new DotCmsRestApi.PersonaContentType();
      //expect(instance).to.be.a(DotCmsRestApi.PersonaContentType);
    });
