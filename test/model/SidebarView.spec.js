...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DotCmsRestApi.SidebarView();
  });
  ...
  describe('SidebarView', function() {
    it('should create an instance of SidebarView', function() {
      // uncomment below and update the code to test SidebarView
      //var instance = new DotCmsRestApi.SidebarView();
      //expect(instance).to.be.a(DotCmsRestApi.SidebarView);
    });
